...
namespace Atlas.Components
{
    abstract class Component
    {
	    ...
	    public bool SetComponentManagerIndex(Entity entity, int index)
	    {
		    ...
		    if(index > componentManagers.Count - 1) 	return false;
	    ...
	    {
		    if(index1 < 0 || index1 > componentManagers.Count - 1) return false;
		    if(index2 < 0 || index2 > componentManagers.Count - 1) return false;
        ...
        public Entity RemoveComponentManager(int index)
	    {
		    ...
		    if(index > componentManagers.Count - 1) return null;
