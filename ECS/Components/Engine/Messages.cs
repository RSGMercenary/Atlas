...
{
	#region Interfaces
	public interface IEngineMessage<out T> : IPropertyMessage<T, IEngine> where T : IEngineItem, IMessenger { }
	...
	#region Classes
	class EngineMessage<T> : PropertyMessage<T, IEngine>, IEngineMessage<T> where T : IEngineItem, IMessenger
	{
